...
<script runat="server">
	...
	string szTransResp = ((string)additionalParamtable["varTempCardNum"]);	
	 
	 	 string strSeries="";
       		result = new JObject();
		 xmlDoc = new XmlDocument();
		string xmlPath = HttpContext.Current.Server.MapPath("~/");
        xmlPath = xmlPath + "\\src\\CreditCardSeries.xml";
		xmlDoc.Load(xmlPath);
		string searchString = "cardseries/card/card_"+szTransResp;
       ...
       //*****************************
        ...
        result = new JObject(new JProperty("RtnVal",strSeries));
        }
	     ...
	     result = new JObject(new JProperty("RtnVal",errMsg));
	        }
       finally{
       if (xmlDoc != null)
         xmlDoc = null;
