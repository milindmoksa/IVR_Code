...
<script runat="server">
    ...
    public override JObject PerformLogic(JObject state, Hashtable additionalParams)
    {
      ...
      //connstring ="Provider=MSDAORA.1;Persist Security Info=False;User ID=OCS_DEVDB;password=OCS_DEVDB_123;Initial Catalog=GENDEV1;Data Source=10.24.94.25";
      connstring ="User ID=OCS_DEVDB;password=OCS_DEVDB_123;Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.24.94.25)(PORT=8888))(CONNECT_DATA=(SERVICE_NAME=GENDEV1)));";
