...
<script runat="server">
	...
	string szTransResp = ((string)additionalParamtable["varBlockCode"]);	
        ...
        xmlPath = xmlPath + "\\src\\CCBlockSeg.xml";
		xmlDoc.Load(xmlPath);
        string searchString = "CCBlockseries/block/IVR_Seg_" + szTransResp;
       ...
       //*****************************
        ...
        result = new JObject(new JProperty("RtnBlockSeg",strSeg));
        }
	     ...
	     result = new JObject(new JProperty("RtnBlockSeg",errMsg));
	        }
       finally{
       if (xmlDoc != null)
         xmlDoc = null;
